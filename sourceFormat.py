...
class Formatter():
	...
	def __init__(self, formatStyle, language, publicationType, a1FirstName="", a1LastName="", a2FirstName="", a2LastName="", a3FirstName="", a3LastName="", pageNumberRange="", publishedYear="", publicationName="", publisherName="", publisherLocation="", publicationURL="", fetchedDate=""):
		...
		self.tmpHarvardFull = {}
		self.tmpHarvardFull["book"] = [((a1LastName + ", "), (a1LastName != "")), ((self.getInitials(a1FirstName) + ". "), (a1FirstName != "")), (("& "), ((a2FirstName != "" or a2LastName != "") and (a3FirstName == "" and a3LastName == ""))), ((a2LastName + ", "), (a2LastName != "")), ((self.getInitials(a2FirstName) + ". "), (a2FirstName != "")), (("& "), (a3FirstName != "" or a3LastName != "")), ((a3LastName + ", "), (a3LastName != "")), ((self.getInitials(a3FirstName) + ". "), (a3FirstName != "")), ((publishedYear + ", "), (publishedYear != "" and (a1FirstName != "" or a1LastName != ""))), ((publicationName), (publicationName != "")), ((","), (a1FirstName != "" or a1LastName != "")), ((" "), (publicationName != "")), ((publisherName + ", "), (publisherName != "")), ((publisherLocation), (publisherLocation != ""))]
		#self.tmpHarvardFull["film"] = 
		#self.tmpHarvardFull["journal"] = 
		#self.tmpHarvardFull["newspaper"] = 
		self.tmpHarvardFull["webpage"] = [*self.tmpHarvardFull["book"][0:10], ((". "), (publicationName != "")), ((self.languages[language]["availableFrom"] + publicationURL + ". "), (publicationURL != "")), (("[{}]".format(self.formatDate(fetchedDate))), (fetchedDate != ""))]
...
if __name__ == "__main__":
	...
	formatterInst = Formatter(**argDict)
	print(formatterInst.output)
